...
public class MapDisplay : MonoBehaviour
{
    ...
    [SerializeField] private InputField accuracyInput;
    ...
    public void OnToggleLineOfSight(bool isShowing)
    {
        ...
        {
            if (IsIndexInRange(selectedCellIndex))
                LineOfSight.ShowAllLinesOfSight(accuracy, selectedCellIndex, (int)width, cells);
        }
        else
        {
    ...
    public void SetAccuracy(string accuracyString)
    {
        ...
        {
            if (IsIndexInRange(selectedCellIndex) && isShowingLineOfSight)
            {
                 LineOfSight.ShowAllLinesOfSight(accuracy, selectedCellIndex, (int)width, cells);
            }
        }
    ...
    public void SetSpeed(string speedString)
    {
        ...
        {
            if (IsIndexInRange(selectedCellIndex) && isShowingMovement)
            {
                Movement.ShowAllMovementCost(speed, selectedCellIndex, cells);
            }
        }
    ...
    private static bool GetMouseWorldPosition(out Vector3 mousePosition)
    {
        int layerMask = 1 << 8;
    ...
    private void OnMouseDown()
    {
        ...
        bool hasHit = GetMouseWorldPosition(out mousePosition);
        if (hasHit)
        {
